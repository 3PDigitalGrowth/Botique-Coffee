...
export const metadata: Metadata = {
  ...
  description:
    "Three tiers of Melbourne workplace coffee machine rental, sized to your team. Small office from $35/week, mid-size from $55/week, large office from $85/week. 30-day free trial, no lock-in. Call Chris on 0411 876 625.",
  openGraph: {
    title:
      "Coffee Machine Rental Packages for Melbourne Workplaces, Boutique Coffee at Work",
    description:
      "Small, mid-size, and large office coffee machine rental tiers. From $35 a week, 30-day free trial, no lock-in. Melbourne metro only.",
    type: "website",
  },
}
